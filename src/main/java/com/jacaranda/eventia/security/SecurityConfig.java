		...
		SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
			http.csrf(csrf -> csrf.disable())
				...
				requests
					...
					.requestMatchers("/userById/**").permitAll()
					.requestMatchers("/eventsByUser/**").permitAll()
					.requestMatchers("/eventsByOrg/**").permitAll()
					.requestMatchers("/participation/**").permitAll()
					.requestMatchers("/valoration/**").permitAll()
					.requestMatchers("/participants/**").permitAll()
					.requestMatchers("/notifications/**").permitAll()
					.requestMatchers("/users/**").permitAll()
					.requestMatchers("/changeRol/**").permitAll()
