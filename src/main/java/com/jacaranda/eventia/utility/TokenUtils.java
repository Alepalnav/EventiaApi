package com.jacaranda.eventia.utility;
...
import com.jacaranda.eventia.exception.ExceptionTokenNotValid;
...
public class TokenUtils {
	 ...
	 */
    public static String generateToken(Integer id,String username, String email,String role)  {
